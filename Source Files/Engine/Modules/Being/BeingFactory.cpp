...
namespace BeingFactory {
    Entity SpawnBeing(EntityManager& registry, const BeingMapData& data, const sf::Texture* atlas, int initialTileID, SpawnDefault spawnDefaults, float overrideX, float overrideY) {
